...
import Validate from "../../validation/ValidateShipments";
...
const AddShipping = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!Object.keys(newErrors).length) {
      const { date, estimated_date } = data;
      if (date > estimated_date) {
        setErrorsMsg("Estimated Date Should be bigger than Arrival Date");
      } else {
        try {
          ...
          <div className="card mx-auto w-50">
            ...
            <div className="card-body">
              <form onSubmit={handleSubmit} className="row g-3">
                ...
                <div className="col-md-6">
                  <label htmlFor="inputfromlocation4" className="form-label">
                    From Location
                  </label>
                  <input
                    type="text"
                  ...
                  {errors && errors.from_location && (
                    <span className="text-danger">{errors.from_location}</span>
                  )}
                </div>
                <div className="col-md-6">
                  <label htmlFor="inputtolocation4" className="form-label">
                    To Location
                  </label>
                  <input
                    type="text"
                  ...
                  {errors && errors.to_location && (
                    <span className="text-danger">{errors.to_location}</span>
                  )}
                </div>
                <div className="col-md-6">
                  <label htmlFor="inputpaymentAmount4" className="form-label">
                    Payment Amount
                  </label>
                  <input
                    type="text"
                ...
                {errorsMsg && errorsMsg && (
                  <span className="text-danger">{errorsMsg}</span>
                )}
